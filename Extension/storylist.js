chrome.storage.sync.get("preferenceStoryList", (e) => {
    if (!chrome.runtime.lastError && e.preferenceStoryList) {
        storyListData = [];
        ...
        $("#mainContent > h1").text("Storygames");

        var getHTML = $.get(chrome.extension.getURL("storylist.html"), (data) => {
                $("#mainContent > table").replaceWith($(data));
